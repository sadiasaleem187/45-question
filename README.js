...
let destinations = ["Kyoto", "Santorini", "Machu Picchu", "Reykjavik", "Bora Bora"];
console.log("Original order of destinations:");
console.log(destinations);
console.log("\nAlphabetical order of destinations:");
console.log(destinations.slice().sort());
console.log("\nStill in original order:");
console.log(destinations);
console.log("\nReverse alphabetical order of destinations:");
console.log(destinations.slice().sort().reverse());
console.log("\nStill in original order:");
console.log(destinations);
destinations.reverse();
console.log("\nReversed order of destinations:");
console.log(destinations);
destinations.reverse();
...
let mountains=["Hindu Kush","Karakoram","Kirthar Mountains"]
...
let arr=["Sadia","aleeza","sadaf"]
console.log(arr.includes("erum"))
console.log(arr)
// Q23:
...
console.log(x>y)
// test 3
console.log('Is x is equals to y? I predict false ')
console.log(x==y)
// test 4
console.log('Is x is equals to y? I predict false ')
console.log(x===y)
// test 5
console.log('Is x is not equals to  y? I predict true ')
console.log(x!=y)
// test 6
console.log('Is x is smaller than an equals to y? I predict true ')
console.log(x<=y)
// test 7
console.log('Is x is Greater than an equals to y? I predict false ')
console.log(x>=y)
// test 8
console.log('Is x is equals to  3 && y is quals to 4? I predict true ')
console.log(x==3 && y==4)
// test 9
console.log('Is x is equals to 2 || y is equals to 3? I predict false ')
console.log(x==2 || y==3)
// test 10
console.log('Is x is equals to 3 || y is equals to 2? I predict true')
console.log(x==3 || y==2)
// Q24:
...
let fruits1="Apple"
let fruits2="orange"
console.log("is friuts1 is equals to friuts2?I predict false")
console.log(fruits1==fruits2)
// test 2
console.log("is friuts1 is equals to friuts2?I predict false")
console.log(fruits1===fruits2)
// test 3
console.log("is friuts1 is equals to friuts2 ignoring datatype?I predict false")
console.log(fruits1.toLowerCase()==fruits2.toLowerCase())
// test 4
let p=3
let q=3
console.log("Is p is equals to q?I predict true")
console.log(p==q)
// test 5
console.log("Is p is equals to q?I predict true")
console.log(p===q)
// test 6
console.log("Is p is equals to 3 && q is equals to 4?I predict false")
console.log(p==3 && q==4)
// test 7
console.log("Is p is equals to3 || q is equals to 3?I predict true")
console.log(p==3 || q==3)
// test 8
console.log("Is p is not equals to q?I predict false")
console.log(p!=q)
// test 9
console.log("Is p is greater then equals to q?I predict true")
console.log(p<=q)
// test 10
console.log("Is p is smaller then equals to q?I predict true")
console.log(p>=q)
// test 11
let arry=["sadia","aleeza","sadaf"]
console.log(arry.includes("zaiba"))
console.log(arry[2])
// Q25:
...
console.log(`${fruits[0]} is my favorite fruits`)
console.log(`${fruits[1]} is my favorite fruits`)
console.log(`${fruits[2]} is my favorite fruits`)
...
let username=["admin","john","eric","wood","max"]
...
let current_users=["sadia","sadaf","erum","zaiba","aleeza"]
let new_users=["sadia","wajdan","yaram","mustafa","tayyab"]
...
let pizza=["Cheese Pizza","Veggie Pizza","Meat Pizza"]
...
let animal=["cat","dog","duck"]
for(let i=0;i<animal.length;i++){
    if(animal[i]==="cat"){
    console.log(`I love ${animal[i]} `)}
    if(animal[i]==="dog"){
    console.log(`${animal[i]} is great pet `)}
    if(animal[i]==="duck"){
    console.log(`the ${animal[i]} is white`)
}
}
// Q36:
...
make_shirt1("medium", "i love javascript")
// Q38:
...
let abc=city_country("lahore","pakistan")
let bc=city_country("islamabad","pakistan")
let cd=city_country("sindh","pakistan")
console.log(abc)
console.log(bc)
console.log(cd)
// Q40:
...
let album3 = makeAlbum("Led Zeppelin", "IV",);
console.log(album1);
console.log(album2);
console.log(album3);
// Q41:
// Magicians: Make a array of magician’s names. Pass the array to a function called show_magicians(), which prints the name of each magician in the array.
let magicians_names=["David Blaine","David Copperfield","Derren Brown"]
...
function make_great(){
    for(let i=0;i<magicians_names.length;i++){
        console.log(`${magicians_names[i]} are the great`)
    }
}
make_great();
// Q43:
// Unchanged Magicians: Start with your work from Exercise 40. Call the function make_great() with a copy of the array of magicians’ names. Because the original array will be unchanged, return the new array and store it in a separate array. Call show_magicians() with each array to show that you have one array of the original names and one array with the Great added to each magician’s name.
function make_great_copy(magicians_names:any){
    for(let i=0;i<magicians_names.length;i++){
        magicians_names[i]="the great" + magicians_names[i]
    }
}
let are=["Dynamo","penn and Teller","Chris Angel"]
make_great_copy(are);
console.log(are)
// Q44:
...
makeSandwich("lettuce", "tomato", "cheese", "mayonnaise");
